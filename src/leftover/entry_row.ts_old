...
export class EntryRow extends Adw.ActionRow {
	...
	declare readonly _prefix_icon: Gtk.Image
	declare readonly _suffix_label: Gtk.Label
	declare readonly _info_button: Gtk.MenuButton
	declare readonly _suffix_icon: Gtk.Image
	declare readonly _info_popover: Gtk.Popover
	declare readonly _info_label: Gtk.Label
