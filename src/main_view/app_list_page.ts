...
export class AppListPage extends Adw.NavigationPage {
	...
	declare readonly _script_group: Adw.PreferencesGroup
	declare readonly _script_row: Adw.ActionRow
	declare readonly _apps_group: Adw.PreferencesGroup
	declare readonly _show_hidden_switch: Gtk.Switch
	declare readonly _list_box: Gtk.ListBox
