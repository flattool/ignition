...
import { Async, type AsyncResult } from "../utils/async.js"
...
export class EntriesPage extends Adw.NavigationPage {
	...
	declare readonly _help_button: Gtk.Button
	declare readonly _search_button: Gtk.ToggleButton
	declare readonly _search_bar: Gtk.SearchBar
	declare readonly _search_entry: Gtk.SearchEntry
	declare readonly _stack: Gtk.Stack
	declare readonly _loading_status: Adw.StatusPage
	declare readonly _no_results_status: Adw.StatusPage
	declare readonly _scrolled_window: Gtk.ScrolledWindow
	declare readonly _home_group: EntryGroup
	declare readonly _root_group: EntryGroup
	declare readonly _add_button: Gtk.Button
	declare readonly _empty_row: Adw.ActionRow
	declare readonly _help_dialog: Adw.Dialog
	...
	constructor() {
		...
		this._home_group.on_results = (has_any): void => {
