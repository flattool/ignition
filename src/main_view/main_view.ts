...
export class MainView extends Adw.Bin {
	...
	declare private _navigation_view: Adw.NavigationView
	declare private _entries_page: EntriesPage
	declare private _app_list_page: AppListPage
	declare private _details_page: DetailsPage
