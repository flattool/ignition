...
export class DetailsPage extends Adw.NavigationPage {
	...
	declare readonly _save_button: Gtk.Button
	declare readonly _create_button: Gtk.Button
	declare readonly _trash_button: Gtk.Button
	declare readonly _root_banner: Adw.Banner
	declare readonly _scrolled_window: Gtk.ScrolledWindow
	declare readonly _content_box: Gtk.Box
	declare readonly _icon: Gtk.Image
	declare readonly _title_group: Adw.PreferencesGroup
	declare readonly _enabled_row: Adw.SwitchRow
	declare readonly _name_row: Adw.EntryRow
	declare readonly _comment_row: Adw.EntryRow
	declare readonly _exec_row: Adw.EntryRow
	declare readonly _path_info_button: Gtk.MenuButton
	declare readonly _terminal_row: Adw.SwitchRow
	declare readonly _delay_adjustment: Gtk.Adjustment
	declare readonly _path_info_popover: Gtk.Popover
	declare readonly _create_dialog: Adw.AlertDialog
	declare readonly _override_dialog: Adw.AlertDialog
	declare readonly _trash_dialog: Adw.AlertDialog
	...
	on_create_dialog_response(_dialog: Adw.Dialog, response: string): void {
	...
	on_override_dialog_response(_dialog: Adw.Dialog, response: string): void {
	...
	on_trash_dialog_response(_dialog: Adw.Dialog, response: string): void {
